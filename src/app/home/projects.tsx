...
export default function Projects() {
  ...
  return (
    <div className="w-full px-4 sm:px-8 lg:px-18 relative mb-10">
      <h2 className="text-3xl sm:text-5xl lg:text-[70px] uppercase tracking-wider pb-6 font-light text-[#131313]">
        {t("projectsTitle", "Projects")}
      </h2>

      <div className="relative border border-[#131313] p-4 sm:p-6 lg:p-8 bg-[#f2f0ea]">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="grid gap-8 sm:gap-10 lg:grid-cols-12 lg:gap-12 items-center"
          >
            {/* Project Image */}
            <div className="lg:col-span-8 relative group overflow-hidden">
              <div className="aspect-[4/3] bg-gradient-to-br from-[#dddbd4] to-[#131313] relative overflow-hidden rounded-md sm:rounded-lg">
                <img
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-90 group-hover:opacity-100 transition-opacity duration-300">
                  ...
                  <motion.button
                    className="w-20 h-20 sm:w-24 sm:h-24 border border-[#f2f0ea] rounded-full flex items-center justify-center backdrop-blur-sm"
              ...
              <div className="mt-6 flex justify-center lg:hidden">
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span
                      className="text-[#131313] text-xs tracking-[0.2em] uppercase"
                    >
                      {t("next", "NEXT")}
                    </span>
                  </div>
            ...
            <div className="lg:col-span-4 space-y-6 sm:space-y-8">
              <div>
                <motion.p
                  className="text-sm sm:text-md tracking-[0.3em] text-[#131313]/50 mb-2 sm:mb-3"
                ...
                <motion.h3
                  className="text-3xl sm:text-4xl lg:text-[50px] text-[#131313] tracking-wider"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <motion.p
                  className="text-base sm:text-md text-[#131313]/50 tracking-wide"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              <motion.p
                className="text-[#131313] font-light leading-relaxed text-base sm:text-md px-0 sm:px-6 md:px-10"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
